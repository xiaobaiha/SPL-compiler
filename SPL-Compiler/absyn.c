...
A_routine_head A_Fuction_Routine_head(A_pos pos, A_decList constPart, A_decList typePart, A_decList varPart, A_decList routinePart)
{
...
A_field A_Fuction_Field(A_pos pos, A_nameList name_list, A_type type_decl)
{
...
A_varDecList A_Fuction_VarDecList(A_pos pos, A_nameList name_list, A_type type_decl)
{
...
A_case A_Fuction_Case(A_pos pos, A_const constValue, table_t name, A_stmt body)
{
