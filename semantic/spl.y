...
%token OF OR PACKED PROCEDURE 
%token PROGRAM RECORD REPEAT SET THEN 
%token TO TYPE UNTIL VAR WHILE WITH
%token SYS_CONSYS_FUNCT SYS_PROC SYS_TYPE
%token NAME INTEGER FLOAT_NUM
...
;
name_list ： name_list  COMMA  NAME  |  NAME
;
...
routine_part:  routine_part  function_decl  |  routine_part  procedure_decl
           |  function_decl  |  procedure_decl  |  /*epsilon*/
;
